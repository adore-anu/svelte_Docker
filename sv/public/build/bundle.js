...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[8](/*index*/ ctx[11]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			br = element("br");
    			add_location(span, file, 35, 4, 776);
    			attr_dev(button, "class", "svelte-1u18vkd");
    			add_location(button, file, 36, 4, 805);
    			add_location(div, file, 34, 2, 766);
    			add_location(br, file, 38, 2, 879);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*eList*/ 2 && t0_value !== (t0_value = /*item*/ ctx[9].text + "")) set_data_dev(t0, t0_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:0) {#each eList as item, index}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "placeholder", "example@gmail.com");
    			attr_dev(input, "class", "svelte-1u18vkd");
    			toggle_class(input, "field-danger", !/*$validity*/ ctx[2].valid);
    			toggle_class(input, "field-success", /*$validity*/ ctx[2].valid);
    			add_location(input, file, 21, 15, 449);
    			button.disabled = button_disabled_value = !/*$validity*/ ctx[2].valid;
    			attr_dev(button, "class", "svelte-1u18vkd");
    			add_location(button, file, 30, 2, 648);
    			add_location(div, file, 20, 0, 428);
    			add_location(br, file, 32, 0, 728);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$validity*/ 4 && button_disabled_value !== (button_disabled_value = !/*$validity*/ ctx[2].valid)) {
    				prop_dev(button, "disabled", button_disabled_value);
    			}

    			if (dirty & /*removeFromList, eList*/ 66) {
    				each_value = /*eList*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const [validity, validate] = createFieldValidator(emailValidator());
    	...
    	function addToList() {
    		$$invalidate(1, eList = [...eList, { text: email, status: false }]);
    		$$invalidate(0, email = "");
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("eList" in $$props) $$invalidate(1, eList = $$props.eList);
    	};
